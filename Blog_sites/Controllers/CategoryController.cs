...
namespace Blog_sites.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Index()
            //Her katergorı model ıcınde kategorı adı == i diyerek kısaca anlatabılırız
        {
            var kategoriler = db.Kategoriler.Select(i => new CategoryModel()
            //select ile yenı bır model olusturduk
            {
                Id=i.Id,
        ...
        //OLUSTURULAN FORMUN GETIYLE OLUSAN NUMARASININ BUARADA BENZERSIZ VE GUVENLI SEKILDE GELMESINI SAGLLIYOR
        ...
        public ActionResult Edit([Bind(Include = "Id,KategoriAdi")] Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                TempData["Kategori"] = category;//tempdata ile kopyalanıyor 
                return RedirectToAction("Index");
            }
            return View(category);
        }
